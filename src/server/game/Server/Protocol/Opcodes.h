...
enum OpcodeClient : uint32
{
    ...
    CMSG_MOVE_KNOCK_BACK_ACK                          = 0x13CA,
    ...
    CMSG_MOVE_START_TURN_LEFT                         = 0xBADDB,
...
enum OpcodeServer : uint32
{
    ...
    SMSG_MOVE_UPDATE_KNOCK_BACK                       = 0x09C1,
    ...
    SMSG_SPLINE_MOVE_GRAVITY_ENABLE                   = 0x0659,
    SMSG_SPLINE_MOVE_ROOT                             = 0x1959,
    SMSG_SPLINE_MOVE_SET_ANIM                         = 0xBADD,
    SMSG_SPLINE_MOVE_SET_FEATHER_FALL                 = 0x01FD,
    SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED            = 0x060C,
    SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED                 = 0x060C,
    SMSG_SPLINE_MOVE_SET_FLYING                       = 0x02BD,
    SMSG_SPLINE_MOVE_SET_HOVER                        = 0x0BD6,
    SMSG_SPLINE_MOVE_SET_LAND_WALK                    = 0x01BC,
    SMSG_SPLINE_MOVE_SET_NORMAL_FALL                  = 0x11B1,
    SMSG_SPLINE_MOVE_SET_PITCH_RATE                   = 0x045C,
    SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED               = 0x0086,
    SMSG_SPLINE_MOVE_SET_RUN_MODE                     = 0x0896,
    SMSG_SPLINE_MOVE_SET_RUN_SPEED                    = 0x1B9A,
    SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED              = 0x0895,
    SMSG_SPLINE_MOVE_SET_SWIM_SPEED                   = 0x098D,
    SMSG_SPLINE_MOVE_SET_TURN_RATE                    = 0x03F6,
    SMSG_SPLINE_MOVE_SET_WALK_MODE                    = 0x03D6,
    SMSG_SPLINE_MOVE_SET_WALK_SPEED                   = 0x01D5,
    SMSG_SPLINE_MOVE_SET_WATER_WALK                   = 0x02D5,
    SMSG_SPLINE_MOVE_START_SWIM                       = 0x01BB,
    SMSG_SPLINE_MOVE_STOP_SWIM                        = 0x1391,
    SMSG_SPLINE_MOVE_UNROOT                           = 0x03B2,
    ...
    SMSG_BATTLE_PET_DELETED                           = 0xBADD, // 5.4.1 17548
    SMSG_BATTLE_PET_ERROR                             = 0xBADD,  // 5.0.5 16048
    ...
    SMSG_BATTLE_PET_JOURNAL_LOCK_DENIED               = 0xBADD, // 5.4.1 17538
    SMSG_BATTLE_PET_LICENSE_CHANGED                   = 0xBADD,  // 5.0.5 16048
    ...
    SMSG_GUILD_EVENT_LEADER                           = 0xBADD, // 5.4.1 17538
    SMSG_GUILD_EVENT_MOTD                             = 0xBADD, // 5.4.1 17538
