...
#define DEFINE_HANDLER(opcode, status, processing, packetclass, handler) \
    ...
    DEFINE_HANDLER(CMSG_GOSSIP_HELLO,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::NPC::Hello, &WorldSession::HandleGossipHelloOpcode);//603
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_LIST_STABLED_PETS,                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleListStabledPetsOpcode     );//603
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LIST_STABLED_PETS,                       STATUS_NEVER);//603
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_STABLE_RESULT,                           STATUS_NEVER);//603
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TRAINER_SERVICE,                         STATUS_NEVER);//603
