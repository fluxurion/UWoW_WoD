...
#define DEFINE_HANDLER(opcode, status, processing, packetclass, handler) \
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_AUCTION_HELLO,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionHelloOpcode        );//603
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AUCTION_HELLO,                           STATUS_NEVER);//603
