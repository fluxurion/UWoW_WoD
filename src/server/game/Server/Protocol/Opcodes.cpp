...
#define DEFINE_HANDLER(opcode, status, processing, packetclass, handler) \
    ...
    DEFINE_HANDLER(CMSG_PORT_GRAVEYARD,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Misc::PortGraveyard, &WorldSession::HandlePortGraveyard);//603
    ...
    DEFINE_HANDLER(CMSG_WHOIS,                                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Who::WhoIsRequest, &WorldSession::HandleWhoisOpcode);//603
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PERIODICAURALOG,                         STATUS_NEVER);//603
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PROCRESIST,                              STATUS_NEVER);//603
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLDAMAGESHIELD,                       STATUS_NEVER);//603
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLDISPELLOG,                          STATUS_NEVER);//603
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLENERGIZELOG,                        STATUS_NEVER);//603
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLHEALLOG,                            STATUS_NEVER);//603
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLLOGMISS,                            STATUS_NEVER);//603
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLNONMELEEDAMAGELOG,                  STATUS_NEVER);//603
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLORDAMAGE_IMMUNE,                    STATUS_NEVER);//603
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_STAND_STATE_UPDATE,                       STATUS_NEVER);//603
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_WHOIS,                                   STATUS_NEVER);//603
