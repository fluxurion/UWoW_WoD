...
const char GarrisonAbilityEntryfmt[] = "nxxxxxx";
const char GarrisonAbilityEffectEntryfmt[] = "nxixxxxxxxx";
const char GarrisonBuildingEntryfmt[] = "niixxissxxiiixxxxxxxixxi";
const char GarrisonEncounterEntryfmt[] = "niiffs";
const char GarrisonEncounterXMechanicEntryfmt[] = "nii";
const char GarrisonFollowerEntryfmt[] = "niixxxxxxxiiixxxxxxxx";
const char GarrisonFollowerXAbilityEntryfmt[] = "niix";
const char GarrisonMechanicEntryfmt[] = "nif";
const char GarrisonMissionEntryfmt[] = "niixixiixixxxxxixii";
const char GarrisonMissionRewardEntryfmt[] = "niiixiixxx";
const char GarrisonMissionXEncounterEntryfmt[] = "nii";
const char GarrisonPlotEntryfmt[] = "nxixxiixx";
const char GarrisonPlotBuildingEntryfmt[] = "nii";
...
char const SpellRuneCostEntryfmt[] = "niiiii";
