...
namespace FactorySelector
{
    CreatureAI* selectAI(Creature* creature)
    {
        ...
        sLog->outDebug(LOG_FILTER_TSCR, "Creature %u used AI is %s.", creature->GetGUID().GetCounter(), ainame.c_str());
    ...
    GameObjectAI* SelectGameObjectAI(GameObject* go)
    {
        ...
        sLog->outDebug(LOG_FILTER_TSCR, "GameObject %u used AI is %s.", go->GetGUID().GetCounter(), ainame.c_str());
