...
Position const BgBfgNodePosition[GILNEAS_BG_DYNAMIC_NODES_COUNT][2] =
{
...
Position const BgBfgDoorPos[4][2] =
{
...
Position const BgBFGBuffsPos[GILNEAS_BG_DYNAMIC_NODES_COUNT] =
{
