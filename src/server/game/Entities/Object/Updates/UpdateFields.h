...
#define PLAYER_FIELD_BYTES PLAYER_FIELD_HAIR_COLOR_ID
#define PLAYER_FIELD_BYTES_2 PLAYER_FIELD_REST_STATE
#define PLAYER_FIELD_BYTES_3 PLAYER_FIELD_ARENA_FACTION
#define PLAYER_SKILL_LINEID_0 PLAYER_FIELD_SKILL
#define PLAYER_SKILL_STEP_0 (PLAYER_SKILL_LINEID_0 + 0x40)
#define PLAYER_SKILL_RANK_0 (PLAYER_SKILL_STEP_0 + 0x40)
#define PLAYER_SKILL_MODIFIER_0 (PLAYER_SKILL_RANK_0 + 0x40)
#define PLAYER_SKILL_MAX_RANK_0 (PLAYER_SKILL_MODIFIER_0 + 0x40)
#define PLAYER_SKILL_TALENT_0 (PLAYER_SKILL_MAX_RANK_0 + 0x40)
#define PLAYER_SKILL_UNKNOWN (PLAYER_SKILL_TALENT_0 + 0x40)
...
enum EUnitFields
{
    ...
    UNIT_FIELD_FLAGS_2 = OBJECT_END + 0x50, // Size: 1 Flags: Public
    UNIT_FIELD_FLAGS_3 = OBJECT_END + 0x51, // Size: 1 Flags: Public
...
enum EItemDynamicFields
{
    ...
    ITEM_DYNAMIC_FIELD_BONUSLIST_IDS = OBJECT_DYNAMIC_END + 0x1, // Size: 1 Flags: Owner
...
enum EGameObjectFields
{
    ...
    GAMEOBJECT_FIELD_SPELL_VISUAL_ID = OBJECT_END + 0xD, // Size: 1 Flags: Public, Urgent
...
enum EAreaTriggerFields
{
    ...
    AREATRIGGER_FIELD_DURATION = OBJECT_END + 0x4, // Size: 1 Flags: Public
    AREATRIGGER_FIELD_SPELL_ID = OBJECT_END + 0x5, // Size: 1 Flags: Public
