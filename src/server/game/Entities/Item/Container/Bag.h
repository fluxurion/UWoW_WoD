...
class Bag : public Item
{
    public:
        ...
        bool Create(ObjectGuid::LowType const& guidlow, uint32 itemid, Player const* owner);
        ...
        bool LoadFromDB(ObjectGuid::LowType const& guid, ObjectGuid const& owner_guid, Field* fields, uint32 entry);
