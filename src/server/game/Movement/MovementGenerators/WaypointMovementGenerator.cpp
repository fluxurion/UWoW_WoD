...
void WaypointMovementGenerator<Creature>::LoadPath(Creature &creature)
{
    ...
    if (!i_path)
    {
        ...
        //sLog->outError(LOG_FILTER_SQL, "WaypointMovementGenerator::LoadPath: creature %s (Entry: %u GUID: %u) doesn't have waypoint path id: %u", creature.GetName(), creature.GetEntry(), creature.GetGUID().GetCounter(), path_id);
        return;
    }
