...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_EnableMvAnticheatDebug = sConfigMgr->GetBoolDefault("Anticheat.MovementDubug.Enable", false);
    ...
    m_int_configs[CONFIG_ARENA_SEASON_ID]                            = sConfigMgr->GetIntDefault ("Arena.ArenaSeason.ID", 14);
    ...
    m_int_configs[CONFIG_PVP_ITEM_LEVEL_CAP]                         = sConfigMgr->GetIntDefault ("PVP.ItemLevelCap", 542);
    ...
    if(toLoad)
    {
        do
        {
            ...
            else
            {
                ...
                if (transferId && realmHandle.Index != 59)
