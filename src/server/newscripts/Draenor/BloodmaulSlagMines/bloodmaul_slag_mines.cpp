            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_1:
                        ...
                        break;
                    case EVENT_2:
                        events.ScheduleEvent(EVENT_2, urand(4, 12) * IN_MILLISECONDS);
...
public:
    ...
    struct npc_bloodmaul_flamespeakerAI : public ScriptedAI
    {
        ...
        {
            events.Reset();
            events.ScheduleEvent(EVENT_1, urand(2, 5) * IN_MILLISECONDS);
            events.ScheduleEvent(EVENT_2, urand(7, 13) * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                {
                    case EVENT_1:
                        events.ScheduleEvent(EVENT_1, urand(5, 14) * IN_MILLISECONDS);
...
public:
    ...
    struct npc_bloodmaul_gnasherAI : public ScriptedAI
    {
        ...
        {
            events.Reset();
            events.ScheduleEvent(EVENT_1, urand(1, 3) * IN_MILLISECONDS);
            events.ScheduleEvent(EVENT_2, urand(5, 10) * IN_MILLISECONDS);
        }
...
public:
    ...
    struct npc_bloodmaul_magma_lordAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            events.ScheduleEvent(EVENT_2, urand(3, 6) * IN_MILLISECONDS);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_1:
                        ...
                        break;
                    case EVENT_2:
                        events.ScheduleEvent(EVENT_2, urand(3, 8) * IN_MILLISECONDS);
...
public:
    ...
    struct npc_bloodmaul_magma_binderAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            events.Reset();
            events.ScheduleEvent(EVENT_1, urand(2, 5) * IN_MILLISECONDS);
            events.ScheduleEvent(EVENT_2, urand(6, 10) * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                {
                    case EVENT_1:
                        events.ScheduleEvent(EVENT_1, urand(2, 7) * IN_MILLISECONDS);
                        DoCastVictim(SPELL_LAVA_BURST);
                        break;
                    case EVENT_2:
                        events.ScheduleEvent(EVENT_2, urand(10, 16) * IN_MILLISECONDS);
    ...
    struct npc_bloodmaul_molten_earth_elementalAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                {
                    case EVENT_1:
                        events.ScheduleEvent(EVENT_1, urand(3, 7) * IN_MILLISECONDS);
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_1:
                        ...
                        break;
                    case EVENT_2:
                        events.ScheduleEvent(EVENT_2, urand(7, 11) * IN_MILLISECONDS);
...
public:
    ...
    struct npc_bloodmaul_orgre_mageAI : public ScriptedAI
    {
        ...
        {
            events.Reset();
            events.ScheduleEvent(EVENT_1, urand(1, 4) * IN_MILLISECONDS);
            events.ScheduleEvent(EVENT_2, urand(10, 15) * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                {
                    case EVENT_1:
                        events.ScheduleEvent(EVENT_1, urand(4, 8) * IN_MILLISECONDS);
                        DoCastVictim(SPELL_LAVA_BURST);
                        break;
                    case EVENT_2:
...
public:
    ...
    struct npc_bloodmaul_overseerAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            events.Reset();
            events.ScheduleEvent(EVENT_1, urand(1, 3) * IN_MILLISECONDS);
            events.ScheduleEvent(EVENT_2, urand(7, 12) * IN_MILLISECONDS);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_1:
                        ...
                        break;
                    case EVENT_2:
                        events.ScheduleEvent(EVENT_2, urand(3, 7) * IN_MILLISECONDS);
    ...
    struct npc_bloodmaul_enforcerAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                {
                    case EVENT_1:
                        events.ScheduleEvent(EVENT_1, urand(3, 6) * IN_MILLISECONDS);
                        events.ScheduleEvent(EVENT_3, urand(4, 7) * IN_MILLISECONDS);
                        DoCastVictim(SPELL_BEATDOWN);
                        break;
                    case EVENT_3:
                        events.ScheduleEvent(EVENT_1, urand(3, 10) * IN_MILLISECONDS);
...
public:
    ...
    struct npc_bloodmaul_slaverAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            events.Reset();
            events.ScheduleEvent(EVENT_1, urand(1, 3) * IN_MILLISECONDS);
            events.ScheduleEvent(EVENT_2, urand(5, 12) * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                {
                    case EVENT_1:
                        events.ScheduleEvent(EVENT_1, urand(2, 4) * IN_MILLISECONDS);
                        events.ScheduleEvent(EVENT_3, urand(3, 12) * IN_MILLISECONDS);
...
public:
    ...
    struct npc_bloodmaul_magma_elementalAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            events.ScheduleEvent(EVENT_1, urand(1, 3) * IN_MILLISECONDS);
            events.ScheduleEvent(EVENT_2, urand(5, 12) * IN_MILLISECONDS);
            events.ScheduleEvent(EVENT_3, urand(4, 10) * IN_MILLISECONDS);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_1:
                        ...
                        break;
                    case EVENT_3:
                        events.ScheduleEvent(EVENT_3, urand(8, 13) * IN_MILLISECONDS);
    ...
    struct npc_bloodmaul_geomancerAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                {
                    case EVENT_1:
                        events.ScheduleEvent(EVENT_1, urand(4, 6) * IN_MILLISECONDS);
                        DoCastVictim(SPELL_STONE_BOLT);
                        break;
                    case EVENT_2:
                        events.ScheduleEvent(EVENT_2, urand(20, 30) * IN_MILLISECONDS);
                        if (urand(0, 1))
